...
java -jar /Users/s/Downloads/selenium-server-standalone-3.4.0.jar -role node -browser browserName=chrome -port 4449 -hub http://selenium.bars-parser.com:4444/grid/register -host 37.57.124.190